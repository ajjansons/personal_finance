      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex-1">
          <div className="flex items-center gap-2">
            ...
            {record?.provider && (
              <div className="flex items-center gap-1 text-xs text-slate-500" title={`Generated by ${record.provider}`}>
                <ProviderIcon provider={record.provider} className="text-slate-400" />
                <span className="hidden sm:inline">{record.modelId}</span>
              </div>
            )}
          </div>
